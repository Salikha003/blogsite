...
class CommentPage(models.Model):
    ...
    parent_id = models.ForeignKey('CommentPage', on_delete=models.CASCADE, related_name='replies', blank=True, null=True)
    ...
    def get_absolute_url(self):
        return reverse('blog_single.html', args=[str(self.pk)])


    @property
    def getReplies(self):
        return CommentPage.objects.filter(parent_id=self).reverse()
